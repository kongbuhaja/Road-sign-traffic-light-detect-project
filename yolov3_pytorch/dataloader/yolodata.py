...
class Yolodata(Dataset):
    ...
    anno_dir = ""
    file_txt = ""
    train_dir = "/home/ubuntu/project2/data/new/train"
    train_txt = "all.txt"
    valid_dir = "/home/ubuntu/project2/data/new/eval"
    valid_txt = "all.txt"
    class_str = ['left', 'right', 'stop', 'crosswalk', 'trafic_light_green_up', 'trafic_light_green_down', 'trafic_light_red_up', 'trafic_light_red_down', 'traffic_light_yollow']
    num_class = None
    img_data = []
