# nohup python3 main.py --mode train --gpus 0 --cfg yolov3-tiny.cfg --pretrained yolov3-tiny.weights > train.log 2>&1 &
# nohup python3 main.py --mode train --gpus 0 --cfg yolov3-tiny.cfg --checkpoint output/model_epoch0.pth > train.log 2>&1 &
# tensorboard --logdir=./output --port 8888
# python3 main.py --mode demo --gpus 0 --cfg yolov3-tiny.cfg --checkpoint output/model_epoch100.pth
import os,sys
