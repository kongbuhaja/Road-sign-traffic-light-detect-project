# nohup python main.py --mode train --gpus 0 --cfg yolov3-tiny.cfg --pretrained yolov3-tiny.weights > train.log 2>&1 &
# nohup python main.py --mode train --gpus 0 --cfg yolov3-tiny.cfg --checkpoint output/model_epoch0.pth > train.log 2>&1 &
# tensorboard --logdir=./output --port 6006
# python main.py --mode demo --gpus 0 --cfg yolov3-tiny.cfg --checkpoint output/model_epoch100.pth
import os,sys
...
def demo(cfg_param = None, using_gpus = None):
    ...
    for f_boxes in demo.boxes:
        text = ""
        boxes = f_boxes[0]
        if boxes.shape[0]==0:
            text="[]\n"
        for box in boxes:
            x, y, w, h, c, l = box.numpy()
            text += f'[{x} {y} {w} {h} {c} {l}], '
