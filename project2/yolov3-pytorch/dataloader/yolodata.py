...
class Yolodata(Dataset):
    ...
    anno_dir = ""
    file_txt = ""
    train_dir = "C:/Users/pcar5/ML/devcourse/aws/project2/data/new/train"
    train_txt = "all.txt"
    valid_dir = "C:/Users/pcar5/ML/devcourse/aws/project2/data/new/eval"
    valid_txt = "all.txt"
    # class_str = ['left', 'right', 'stop', 'crosswalk', 'uturn', 'trafic_light_green_up', 'trafic_light_green_down', 'trafic_light_red_up', 'trafic_light_red_down', 'traffic_light_yollow', 'traffic_light_off']
    class_str = ['left', 'right', 'stop', 'crosswalk', 'uturn', 'trafic_light']
    num_class = None
    img_data = []
    ...
    def __getitem__(self, index):
        ...
        if os.path.isdir(self.anno_dir):
            ...
            #skip empty target
            if bbox.shape[0] == 0:
                img, _ = self.transform((img, np.array([[0,0,0,0,0]], dtype=np.float64)))
